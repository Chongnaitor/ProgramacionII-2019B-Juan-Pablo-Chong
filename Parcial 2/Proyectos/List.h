...
public:
	 ...
	 * @return [void]
	 */
	void push(SingleNode *nodo, unsigned int position);
	 ...
	 * @return [SingleNode *] The unlinked node
	 */
	SingleNode * pull(unsigned int position);
	 ...
	 */
	friend std::ostream & operator << (std::ostream &out, SingleList &nodo);
...
public:
	 ...
	 * @return [void]
	 */
	void push(DoubleNode *dnodo, unsigned int position);
	 ...
	 * @return [DoubleNode *] The unlinked node
	 */
	DoubleNode * pull(unsigned int position);
	 ...
	 * Concatenates all the nodes to the output stream
	 */
	friend std::ostream & operator << (std::ostream &out, DoubleList &dnodo);
